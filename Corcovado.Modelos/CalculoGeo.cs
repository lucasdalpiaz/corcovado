...
namespace Corcovado.Modelos
{
    public class CalculoGeo
    {
            ...
            )
        {
            ...
            CalculoX();
            CalculoDistanciaM();
            CalculoContraAzimuteDecimal();
            CalculoContraAzimuteGrau();
            CalculoContraAzimuteMinuto();
            CalculoContraAzimuteSegundo();
            CalculoAzimuteBDecimal();
            CalculoAzimuteBGrau();
            CalculoAzimuteBMinuto();
            CalculoAzimuteBSegundo();
            CalculoRumoGDS();
            CalculoQuadrante();
            CalculoDiffHora();
            CalculoVelocidadeKm();
            CalculoVelocidadeKnots();
        ...
        {
            C1 = (Math.Pow((C / B) , 2)) * Math.Pow(X1 , 3) * (2.0 / 3.0);
        }
        #endregion
